...
while (true) {
    ...
    if (option == "1") {
        ...
        const id_that_the_user_needs_to_update = Number(readlineSync.question("Από ποια σημείωση θέλεις να κάνεις ενημέρωση (id): "));
        const updated_version_note = readlineSync.question("Γράψε την ενημερωμένη έκδοση της σημείωσης: ");
        ...
        const delete_id = Number(readlineSync.question("Ποια σημείωση θέλεις να διαγράψεις (id): "));
